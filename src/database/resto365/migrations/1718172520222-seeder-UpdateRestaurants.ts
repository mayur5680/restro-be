...
import restaurants from '../migrations-data/12_06_2023_restaurant.json';

export class UpdateRestaurants1718172520222 implements MigrationInterface {
  name = ' UpdateRestaurants1718172520222';
