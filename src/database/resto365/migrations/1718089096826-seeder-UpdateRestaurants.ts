...
import restaurants from '../migrations-data/11_06_2023_restaurant.json';

export class UpdateRestaurants1718089096826 implements MigrationInterface {
  name = 'UpdateRestaurants1718089096826';
